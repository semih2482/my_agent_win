# agent/tools/investment_advisor.py

from agent.tools.comprehensive_financial_analyst import run as analyze_investment_query
from typing import Dict, Any

def run(query: str, investment_horizon: str = "belirtilmedi", risk_profile: str = "belirtilmedi", agent_instance=None) -> Dict[str, Any]:
    """
    ...
    """
    print("--- UYARI: `get_investment_advice` aracı eskidir ve `analyze_investment_query` aracına yönlendiriliyor. ---")
